...
subroutine setup
  ...
  allocate(Vc(nmetal),e_metal(nmetal))
...
subroutine write_average
  ...
  do i=1,nsteps/nstep_avg
   ...
   ! enddo
   write(100,'(21f17.3)')(i-1)*nstep_avg*dtc*1.d12,pop(1,i)!rho(1,1,i)
  enddo
...
!  state(n_el)=state(n_el)+2
  ...
  do i=1,1000
    ...
    call evaluate_variables(0)
    write(20,'(12f10.2)') x(1)*1.d10,V_k(1:10)/wave_to_J
